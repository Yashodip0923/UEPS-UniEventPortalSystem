...
<head>
    ...
    <title>Set New Password - UniEventPortal</title>
...
<body class="bg-light text-dark">
            ...
            <div class="col-10">
                <div class="card shadow-lg rounded-3">
                    <div class="card-body p-4">
                        ...
                        <p class="text-center text-muted mb-3">Please enter and confirm your new password.</p>
                        ...
                        <form action="api/users/reset_password_process.php" method="POST">
                            <input type="hidden" name="email" value="<?php echo $email; ?>">
                            <div class="mb-1 position-relative">
                                <label for="newPassword" class="form-label">New Password</label>
                                <input type="password" class="form-control" id="newPassword" name="new_password" required>
                                <div class="input-icon-container">
                                    <svg id="newPasswordSuccessIcon" class="icon-success" viewBox="0 0 24 24" fill="currentColor" style="display: none;">
                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                    </svg>
                                    <svg id="newPasswordErrorIcon" class="icon-error" viewBox="0 0 24 24" fill="currentColor" style="display: none;">
                            ...
                            <div class="mb-1 position-relative">
                                ...
                                <div class="input-icon-container">
                                    <svg id="confirmNewPasswordSuccessIcon" class="icon-success" viewBox="0 0 24 24" fill="currentColor" style="display: none;">
                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                    </svg>
                                    <svg id="confirmNewPasswordErrorIcon" class="icon-error" viewBox="0 0 24 24" fill="currentColor" style="display: none;">
                                        <path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/>
                                    </svg>
                                </div>
                                <span id="confirmNewPasswordError" class="text-danger small"></span>
                            </div>
                            <div class="d-grid gap-1">
                                <button type="submit" class="btn btn-primary py-2 rounded-lg fw-semibold mt-3">Reset Password</button>
                            </div>
                            <p class="text-center mt-2 mb-0"><a href="login.php">Back to Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script src="api/js/reset_new_password_validation.js"></script>
</body>
